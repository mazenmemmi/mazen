...
echo'<table border="0">';
echo'<tr class="trSlider">';
echo '<td class="tdSlider">';
include ("slider.php");
echo '</td>';
...
<div id="boxService1">
  ...
  <div id="boxBeratung1">
    <a href="#"><img src="images/contact123.png" width=180px height=100px alt="Wir beraten Sie gerne" /></a>
  </div>
