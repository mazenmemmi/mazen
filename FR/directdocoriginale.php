...
echo'<img border="0" src="images/flash2.jpg">';//include ("slider2.php");
...
while ($dsq=mysqli_fetch_array($dsql))
{
		...
		$red="select * from artproduit where srubID=".$dsq["srubID"]."  GROUP BY Marquepro ;";
           $Rre = mysqli_query($red) or die('Erreur de chargement !');
		echo'<ul>';
...
$RSdoc = mysqli_query($sqldoc) or die('Erreur de chargement !');
...
$resultat = mysqli_query($sql) or die('Erreur de chargement !');
