                ...
                <td width="100%">
                  <table border="0" width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <font color="#008000"><b>Cat�gories de ressources</b></font></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
$TableName="ressourcescat";
$TableKey="catid";
$OrderBy="catlibelle";

// related table (integrity) ( 2 table ) for delete
$RTableName1="ressources";
$RTableKey1="catid";
$RTableName2="";
$RTableKey2="";
...
<table border="0" width="100%" bgcolor="#A4BCDD" cellpadding="2" cellspacing="1">
         <tr>
           <td width="30%" bgcolor="#C6D6E8" height="20"><font color="#800000"><B>Libell�</B></font></td>
           <td width="30%" bgcolor="#C6D6E8" height="20"><font color="#800000"><b>Description</b></font></td>
        ...
        <form method="POST" action="<?   echo thisscript();?>" name="theform" onsubmit="return validatetheform()">   
                  <table border="0" width="100%" bgcolor="#A4BCDD" cellspacing="1">
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFFF"><input type="text" maxlength="255" name="frmcatdescription" size="30" value="<?   echo $RSA["catdescription"];?>"></td>
                    </tr>
                    <tr>
...
?>
        <form method="POST" action="<?   echo thisscript();?>" name="theform" onsubmit="return validatetheform()">   
                  <table border="0" width="100%" bgcolor="#A4BCDD" cellspacing="1">
                    ...
                    <tr>
                      <td bgcolor="#C6D6E8"><font color="#800000"><b>Description</b></font></td>
                      <td bgcolor="#FFFFFF"><input type="text" maxlength="255" name="frmcatdescription" size="30" value=""></td>
                    </tr>
                    <tr>
                      <td bgcolor="#C6D6E8" colspan="2">
...
// update rec
  ...
  $RSA["catdescription"]=$_POST["frmcatdescription"];
