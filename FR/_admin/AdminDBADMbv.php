                ...
                <td width="100%">
                  <table border="0" width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <font color="#008000"><b>banni�res verticale</b></font></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
if ( isNaN(parseInt(document.theform.frmbannerorder.value,10))) 
{ 
 alert ('Ordre manquant ou invalide') ; document.theform.frmbannerorder.focus() ; 
 return false ; 
}

document.theform.frmbannerorder.value=parseInt(document.theform.frmbannerorder.value,10);
...
<table border="0" width="100%" bgcolor="#A4BCDD" cellpadding="2" cellspacing="1">
         <tr>
              <td width="5%" bgcolor="#C6D6E8"><font color="#800000"><b>Ordre</b></font></td>
              ...
              <td width="25%" bgcolor="#C6D6E8"><font color="#800000"><b>Action</b></font></td>
            </tr>
...
?>
              <tr bgcolor="#EEF2F9">
              <td><b><?     echo $RSA["bannerorder"];?></b></td>
...
?>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFFF"><input type="text" onkeypress="event.returnValue=IsDigit();" maxlength="4" name="frmbannerorder" size="30" value="<?     echo $RSA["bannerorder"];?>"></td>
                    </tr>
                    <tr>
...
?>
                    ...
                    <tr>
                      <td bgcolor="#C6D6E8"><font color="#800000"><b>Ordre</b></font></td>
                      <td bgcolor="#FFFFFF"><input type="text" onkeypress="event.returnValue=IsDigit();" maxlength="4" name="frmbannerorder" size="30" value=""></td>
                    </tr>
                    <tr>
                      <td width="30%" bgcolor="#C6D6E8"><b><font color="#800000">Lien</b></font></td>
...
// update rec
      ...
      $RSA["bannerorder"]=$_POST["frmbannerorder"];
