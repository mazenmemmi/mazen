...
<!--
	...
	-->		  
             ...
             <tr>
                <td width="100%" bgcolor="#FFFFFF" height="12"><img border="0" src="images/pucevert.gif" >&nbsp;<a href="AdminDBADMproduits.php">Produits</a></td>
              </tr>
<!--
			  <tr>
                ...
                <td width="100%" bgcolor="#D2DEEE">
                  <table border="0" width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="81%" valign="bottom"><b><font face="Arial" color="#1A62B0" size="2">Médias</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
               <tr>
                <td width="100%" bgcolor="#FFFFFF"><img border="0" src="images/pucevert.gif" width="14" height="14">&nbsp;<a href="AdminFileManager.php">Gestion des médias</a></td>
              </tr>
              <!--
...
<TABLE width=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
		...
		<TD BGCOLOR=#D2DEEE valign="top" width="100%">
            <table border="0" width="100%" bgcolor="#A4BCDD" cellspacing="1">
              ...
              <tr>
                <td width="100%" bgcolor="#FFFFFF"><img border="0" src="images/pucevert.gif" width="14" height="14">&nbsp;<a href="AdminDBADMusers.php">Gestion des Utilisateurs</a></td>
              </tr>
	...
	<!--
              ...
              <tr>
                <td width="100%" bgcolor="#FFFFFF"><img border="0" src="images/pucevert.gif" width="14" height="14">&nbsp;<a href="../../phpbb2/">Administration du forum</a></td>
              </tr>
			-->
            </table>
        </TD>
...
?>
            ...
            <a href="deconnexion.php"><img border="0" src="images/iconlogout.gif"></a>
            </td>
        </tr>
      </table>
    </td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td bgcolor="#D2DEEE" align="right"><?php  echo $AppCopyHTML;?></td>
  </tr>
  <tr>
