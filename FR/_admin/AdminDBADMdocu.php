...
//    echo mysqli_query($DBO,$strSQL)or die('Erreur SQL !<br>'.$strSQL.'<br>'.mysqli_error());
 
//  $RSA=mysqli_query($DBO,$strSQL)or die('Erreur SQL !<br>'.$strSQL.'<br>'.mysqli_error());

$result=mysqli_query($DBO,$strSQL);


if (!$result) {
    // Log the error or handle it appropriately for your application
    error_log('Erreur SQL: ' . mysqli_error($DBO));

    // Display a generic error message to the user
    die('Une erreur est survenue. Veuillez réessayer plus tard.');
}

// Continue processing the result or other actions if needed
