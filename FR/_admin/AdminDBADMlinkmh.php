                ...
                <td width="100%">
                  <table border="0" width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <font color="#008000"><b>Liens du menu hautt</b></font></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
if ($_SESSION['ADMINPROFIL']!="AD")
{
  ...
  $AdminMessage ="Accés non autorisé <br>( vous n'avez pas de privilèges pour cette rubrique )";
}
  else
{
...
// if index selected  ?>  
         <? 
    $strSQL="SELECT ".$ViewFields." from ".$TableName." WHERE ".$ITableKeyC."=".$qryidxid."  ;";
    $RSA->Open($strSQL  ,  $DBO ,   $adOpenStatic ,   $adLockReadOnly);
?>
        <tr>
...
?>
        <form method="POST" action="<?   echo thisscript();?>?frmidxid=<?   echo $qryidxid;?>" name="theform" onsubmit="return validatetheform()">   
                  <table border="0" width="100%" bgcolor="#A4BCDD" cellspacing="1">
                    <tr>
                      <td width="20%" bgcolor="#C6D6E8"><b><font color="#800000">Lien</b></font></td>
                      <td width="80%" bgcolor="#FFFFFF"><input type="text" maxlength="255" name="frmlink" size="30" value="<?   echo $RSA["link"];?>"></td>
                    </tr>
                    <tr>
