                ...
                <td width="100%">
                  <table border="0" width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <font color="#008000"><b>Menu haut</b></font></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
{ 
 if (document.theform.frmarlibelle.value=='')
  {
 alert ('Libell� manquant !');
 document.theform.frmarlibelle.focus();
 return false;
  }
   
 if ( isNaN(parseInt(document.theform.frmarorder.value,10))) 
{ alert ('Ordre manquant ou invalide') ; document.theform.frmarorder.focus() ; 
 return false ; 
}

  document.theform.frmarorder.value=parseInt(document.theform.frmarorder.value,10);
  return true;
...
?>
              <tr bgcolor="#EEF2F9">
                <td> <?     echo $RSA["arlibelle"];?></td>
                <td> <?     echo $RSA["arorder"];?></td>
                <td> <?     echo $RSA["artype"];?></td>
                <td> <?     echo $RSA["ardesc"];?></td>
                <td>
                <a href="<?     echo thisscript();?>?mode=edit&frmid=<?     echo $RSA["arid"];?>"><IMG border="0" SRC="images/bt_modif.gif" alt="Modifier"></a>
                <a href="javascript:confirmDelete('<?     echo thisscript();?>?mode=sup&frmid=<?     echo $RSA["arid"];?>')"><IMG border="0" SRC="images/bt_supp.gif" alt="Supprimer"></a>
                </td>
              </tr>
              <?     $RSA->MoveNext;?>
         <?   } ?>
        ...
        <form method="POST" action="<?   echo thisscript();?>" name="theform" onsubmit="return validatetheform()">   
                  <table border="0" width="100%" bgcolor="#A4BCDD" cellspacing="1">
                    <tr>
                      ...
                      <td width="70%" bgcolor="#FFFFFF"><input type="text" maxlength="50" name="frmarlibelle" size="30" value="<?   echo $RSA["arlibelle"];?>"></td>
                    </tr>
                    <tr>
                      <td bgcolor="#C6D6E8"><font color="#800000"><b>Ordre</b></font></td>
                      <td bgcolor="#FFFFFF"><input type="text" onkeypress="event.returnValue=IsDigit();" maxlength="4" onkeypress="event.returnValue=IsDigit();" name="frmarorder" size="30" value="<?   echo $RSA["arorder"];?>"></td>
                    </tr>
                    <tr>
                      <td bgcolor="#C6D6E8"><font color="#800000"><b>Type</b></font></td>
                      <td bgcolor="#FFFFFF">
                      <select name="frmartype" size=1 class="SELECTCLASS">
                        <?   if ($RSA["artype"]=="DOC")
  {
?>
...
?>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFFF"><textarea rows=3 name="frmardesc" cols=30><?   echo $RSA["ardesc"];?></textarea></td>
                    </tr>
...
?>
        <form method="POST" action="<?   echo thisscript();?>" name="theform" onsubmit="return validatetheform()">   
                  <table border="0" width="100%" bgcolor="#A4BCDD" cellspacing="1">
                    <tr>
                      <td width="30%" bgcolor="#C6D6E8"><b><font color="#800000">Libell�</b></font></td>
                      <td width="70%" bgcolor="#FFFFFF"><input type="text" maxlength="50" name="frmarlibelle" size="30" value=""></td>
                    </tr>
                    <tr>
                      <td bgcolor="#C6D6E8"><font color="#800000"><b>Ordre</b></font></td>
                      <td bgcolor="#FFFFFF"><input type="text" onkeypress="event.returnValue=IsDigit();" maxlength="4" onkeypress="event.returnValue=IsDigit();" name="frmarorder" size="30" value=""></td>
                    </tr>
                    <tr>
                      <td bgcolor="#C6D6E8"><font color="#800000"><b>Type</b></font></td>
                      <td bgcolor="#FFFFFF">
                    ...
                    <tr>
                      <td bgcolor="#C6D6E8"><font color="#800000"><b>Description</b></font></td>
                      <td bgcolor="#FFFFFF"><textarea rows=3 name="frmardesc" cols=30></textarea></td>
                    </tr>
                    <tr>
                      <td bgcolor="#C6D6E8" colspan="2">
...
// update rec
  ...
  $RSA["arlibelle"]=$_POST["frmarlibelle"];
  $RSA["arorder"]=$_POST["frmarorder"];
  $RSA["artype"]=$_POST["frmartype"];
  $RSA["ardesc"]=$_POST["frmardesc"];
